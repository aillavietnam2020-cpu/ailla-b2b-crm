...
| Bản PRODUCTION | https://ailla-b2b-crm.aillavietnam2020.workers.dev |
...
| Worker production | `ailla-b2b-crm` (env `production`) - đã triển khai trên `workers.dev` |
| D1 production | `ailla_crm_prod` · `5a9c1852-0693-4b22-a922-c30a3095dff0` (đã chạy migration 0001–0003) |
| Tài khoản CEO trong D1 production | `aillavietnam2020@gmail.com` · bắt buộc đổi mật khẩu ở lần đăng nhập đầu |
...
Ứng dụng hiện dùng được bằng email + mật khẩu trên địa chỉ `workers.dev`. Các việc dưới đây là
nâng cấp vận hành, không còn chặn việc sử dụng CRM:

1. **Đưa tên miền đã mua vào Cloudflare** (Dashboard → Domains → Add a domain, rồi đổi
...
5. **Tạo tài khoản nhân sự thật** trong màn hình Người dùng (Thảo, Huyền, Quản lý), `legacy_name` phải
